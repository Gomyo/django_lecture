...
각 폴더에는 같은 이름으로 된 마크다운 파일이 있습니다. 해당 회차에 관련된 중요한 내용이 있으니 참고하면서 복습하시기 바랍니다.

`practice` 폴더에는 복습하기 좋은 과제를 넣어 두었습니다. pdf로 되어 있는 것을 보면서 직접 해 보세요. 마크다운은 정답이 기록되어 있습니다.
